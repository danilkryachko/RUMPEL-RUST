...
END {
    ...
    if (worst_packed_line != "") {
        print "worst_packed draw_mode=" value(worst_packed_line, "draw_mode", "?") " generated_regions_loaded=" value(worst_packed_line, "generated_regions_loaded", "?") " generated_regions_active=" value(worst_packed_line, "generated_regions_active", "?") " generated_regions_visible=" value(worst_packed_line, "generated_regions_visible", "?") " generated_update_us=" value(worst_packed_line, "generated_update_us", "?") " generated_update_skipped=" value(worst_packed_line, "generated_update_skipped", "?") " generated_cache_hits=" value(worst_packed_line, "generated_cache_hits", "?") " generated_cache_misses=" value(worst_packed_line, "generated_cache_misses", "?") " generated_cache_invalidated=" value(worst_packed_line, "generated_cache_invalidated", "?") " generated_cache_evicted=" value(worst_packed_line, "generated_cache_evicted", "?") " generated_prepare_skipped=" value(worst_packed_line, "generated_prepare_skipped", "?") " generated_cull_metadata_uploaded=" value(worst_packed_line, "generated_cull_metadata_uploaded", "?") " generated_cull_config_uploaded=" value(worst_packed_line, "generated_cull_config_uploaded", "?") " generated_cull_dispatch_skipped=" value(worst_packed_line, "generated_cull_dispatch_skipped", "?") " visible_quads=" value(worst_packed_line, "visible_quads", "?") " uploaded_quads=" value(worst_packed_line, "uploaded_quads", "?") " indirect_cmds=" value(worst_packed_line, "indirect_draw_commands", "?") " pending_builds=" value(worst_packed_line, "pending_builds", "?") " pending_region_rebuilds=" value(worst_packed_line, "pending_region_rebuilds", "?") " prepare_us=" value(worst_packed_line, "prepare_us", "?") " view_prepare_us=" value(worst_packed_line, "view_prepare_us", "?") " stream_us=" value(worst_packed_line, "stream_us", "?") " build_us=" value(worst_packed_line, "build_task_us", "?") " compaction_us=" value(worst_packed_line, "compaction_us", "?") " uploaded_this_frame=" value(worst_packed_line, "uploaded_this_frame", "?") " render_us=" value(worst_packed_line, "render_node_us", "?") " draw_calls=" value(worst_packed_line, "packed_render_draw_calls", "?") " render_items=" value(worst_packed_line, "packed_render_items_considered", "?") " gpu_pass_us=" value(worst_packed_line, "packed_render_gpu_pass_us", "?") " gpu_cull_enabled=" value(worst_packed_line, "gpu_cull_enabled", "?") " gpu_cull_input_cmds=" value(worst_packed_line, "gpu_cull_input_commands", "?") " gpu_cull_visible_cmds=" value(worst_packed_line, "gpu_cull_est_visible_commands", "?") " gpu_cull_visible_quads=" value(worst_packed_line, "gpu_cull_est_visible_quads", "?") " gpu_cull_us=" value(worst_packed_line, "gpu_cull_node_us", "?") " gpu_cull_count_supported=" value(worst_packed_line, "gpu_cull_count_supported", "?") " gpu_cull_compact_enabled=" value(worst_packed_line, "gpu_cull_compact_enabled", "?") " cpu_visible_compact=" value(worst_packed_line, "cpu_visible_compact_enabled", "?") " cpu_cmds=" value(worst_packed_line, "cpu_visible_commands", "?") " material_entities=" value(worst_packed_line, "material_entities", "?") " material_sync_us=" value(worst_packed_line, "material_sync_us", "?")
    }
